...
public class PeerMessageOps {
	...
	public static final byte OPCODE_FILE_NOT_FOUND = 1;			// AÑADIDO
	public static final byte OPCODE_GET_CHUNCK = 2;				// AÑADIDO
	public static final byte OPCODE_GET_FILE_HASH = 5;			// AÑADIDO
	public static final byte OPCODE_FILE_LIST = 3;				// AÑADIDO
	public static final byte OPCODE_SEND_FILE = 4;				// AÑADIDO
